...
<div class="row g-4">
    <div class="col-lg-4">
        <div class="modern-card bg-white p-4 h-100">
            <div class="d-flex align-items-center mb-4 pb-3 border-bottom">
                <div class="bg-primary bg-opacity-10 text-primary rounded-3 p-3 me-3"><i class="fas fa-tags fs-4"></i></div>
                <h5 class="fw-bold m-0 text-dark">Tambah Kategori Berita</h5>
            </div>
            <form action="<?= base_url('admin/informasi/simpan_kategori_berita') ?>" method="post">
                ...
                <button type="submit" class="btn w-100 rounded-pill py-3 fw-bold shadow-sm border-0 hover-lift text-white" style="background: linear-gradient(45deg, #00f2fe, #4facfe);">SIMPAN KATEGORI</button>
            </form>
        </div>
    </div>
    ...
    <div class="col-lg-8">
        <div class="modern-card bg-white p-4 h-100">
            <h5 class="fw-bold text-dark mb-4 pb-3 border-bottom">Daftar Kategori Berita</h5>

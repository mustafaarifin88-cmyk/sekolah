    ...
    <div class="col-lg-4">
        <div class="modern-card p-4 h-100 border">
            <div class="d-flex align-items-center mb-4">
                ...
                <h5 class="fw-bold m-0 text-dark">Beri Tugas Mapel</h5>
            </div>
            <form action="<?= base_url('admin/aplikasi/simpan_set_mapel') ?>" method="post">
                <div class="mb-3">
                    <label class="form-label fw-bold text-secondary text-uppercase fs-7 tracking-wider">Pilih Guru</label>
    ...
    <div class="col-lg-8">
        <div class="modern-card bg-white p-0 h-100 overflow-hidden border">
            <div class="p-4 border-bottom border-light d-flex justify-content-between align-items-center bg-light">
                <h5 class="fw-bold m-0 text-dark"><i class="fas fa-list me-2" style="color: var(--theme-color);"></i> Distribusi Mapel Guru</h5>
            </div>
                ...
                <table class="table table-hover table-modern mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25 px-3 py-1 rounded-pill"><?= $row['nama_mapel'] ?></span></td>
                        ...
                        <?php endforeach; else: ?>
                        <tr><td colspan="5" class="text-center py-5 text-muted"><i class="fas fa-chalkboard fs-1 mb-3 opacity-50 d-block"></i>Belum ada data penugasan mapel.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header modal-header-custom">
                <h5 class="modal-title fw-bold text-white"><i class="fas fa-edit me-2"></i> Edit Tugas Mapel</h5>
